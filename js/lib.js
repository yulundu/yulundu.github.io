...
jQuery(document).ready(function(){
	...
	function userSubmitFormResponse(response) {
		...
		// Section tabs
		jQuery('#mainpage_accordion_area2').tabs('section > .section_body', {
			tabs: 'section > .section_header > .section_title',
			effect : 'slide',
			slideUpSpeed: 600,
			slideDownSpeed: 600,
			onLoad: function (e, tabIndex) {
				var tabs = jQuery('#mainpage_accordion_area2 section > .section_header > .section_title');
				var tab = tabs.eq(tabIndex);
